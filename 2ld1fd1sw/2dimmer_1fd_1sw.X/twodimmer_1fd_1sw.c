/*
 this is test code two dimmer, 1 fan dimmer and one switch
 * issue: not known
 */
...
void main() {
    ...
    FAN = OFF;    RELAY1 = OFF;        RELAY3 = 1;  RELAY2=1; // RELAY4 = 1;    
	   ...
	   //dimmmer2
	       if(child_LOCK[9]==OFF && SW5==OFF && M5==OFF)
			{    
                if(man==1)
                {
                st[17]='R';st[18]='0'; st[19]='0';st[20]='5'; writeUART(st+17);
                FAN_FLAG2=0;
				RELAY2=1;                 
				}
                M5=1;               
			...
			{    
                if(man==1)
                {
                st[17]='R';st[18]='1';st[19]='0';st[20]='5';writeUART(st+17);
                FAN_FLAG2=0;   
				RELAY2=0;
                }
                M5=0;                
...
//     TRISFbits.TRISF6=1;
     ...
     TRISEbits.TRISE0=0;//regulator
     TRISEbits.TRISE1=0;//fan1
     TRISEbits.TRISE2=0;//fan2
     TRISEbits.TRISE4=0;//fan3
     /* PORT D */  
//     WPUD=0x00;
//     ANSELD=0x00;
//     TRISD=0xFF;

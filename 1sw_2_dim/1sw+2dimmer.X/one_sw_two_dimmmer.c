...
//    }
    ...
    if(PIR1bits.CCP1IF==1 || PIR3bits.CCP3IF == 1 )
    {              
...
//                if(man==1)
//                {
//                st[5]='R';      st[6]='0';      st[7]='0';      st[8]='2';      writeUART(st+5);      RELAY1=OFF;
//				}
//                M2=1;                man=1;
//			}
//	   
...
//                if(man==1)
//                {
//                st[5]='R';      st[6]='1';      st[7]='0';      st[8]='2';      writeUART(st+5);    RELAY1=ONN;   
//				}
//                M2=0;                man=1;
//			}
	   
	///DIMMER1///	
            if(child_LOCK[3]==OFF && SW3==OFF && M3==OFF)
			{
                
                if(man==1)
                {
                st[9]='R';     st[10]='0';     st[11]='0';     st[12]='2';      writeUART(st+9); FAN_FLAG1=0;
				RELAY4=1; 
                }
                M3=1;
                man=1;
			...
			if( child_LOCK[3]==OFF && SW3==ONN && M3==ONN)
			{ 
                
                if(man==1)
                {
                st[9]='R';        st[10]='1';       st[11]='0';       st[12]='2';     writeUART(st+9);FAN_FLAG1=0;
				RELAY4=0;
                }
                M3=0;
                man=1;
	...
	///DIMMER2///	   
	       if(child_LOCK[5]==OFF && SW4==OFF && M4==OFF)
			{    
              
                if(man==1)
                {
                st[13]='R';      st[14]='0';       st[15]='0';       st[16]='3';     writeUART(st+13);FAN_FLAG2=0;
				RELAY3=1;                 
				}
                M4=1;               
                man=1;
			...
			if(child_LOCK[5]==OFF && SW4==ONN && M4==ONN)
			{    
                
                if(man==1)
                {
                st[13]='R';     st[14]='1';        st[15]='0';       st[16]='3';    writeUART(st+13);    FAN_FLAG2=0;   
				RELAY3=0;
                }
                M4=0;                
                man=1;
